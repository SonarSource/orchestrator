...
public class HttpCall {
  ...
  private static final String CANNOT_CALL_MESSAGE = "Can not call %s";
  ...
  public void downloadToFile(File file) {
    ...
    try {
      ...
      try {
        ...
        throw new IllegalStateException(format(CANNOT_CALL_MESSAGE, okRequest.url()), e2);
      }
    } catch (IOException e) {
      throw new IllegalStateException(format(CANNOT_CALL_MESSAGE, okRequest.url()), e);
    }
  }
